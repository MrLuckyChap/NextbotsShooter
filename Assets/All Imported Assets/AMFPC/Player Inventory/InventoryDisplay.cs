...
using All_Imported_Assets.AMFPC.UI.Button;
using UnityEngine;
using UnityEngine.UI;

namespace All_Imported_Assets.AMFPC.Player_Inventory
{
    public class InventoryDisplay : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _itemManager = UnityEngine.Camera.main.gameObject.GetComponentInChildren<ItemManager>();
        ...
        void Start()
        {
            ...
            _cameraLook = UnityEngine.Camera.main.gameObject.GetComponent<CameraLook>();
        }
        void Update()
        {
            UpdateDisplay();
